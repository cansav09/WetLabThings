...
boxplot(target.data$EstimatVals[-xx]~tx.groups,names=c("0 mg/kg","0.3 mg/kg"),cex.main=3,cex.names=1.5,cex.lab=2,cex.axis = 1.5,ylim=c(0,20),xlab="Dose",main=target[ii],col=c("palegreen4","orange"))
}
dev.off()
...
for(ii in 1:length(target)){
  ...
  bars=barplot(avg,names=c("0 mg/kg","0.3 mg/kg"),cex.main=3,cex.names=1.5,cex.lab=2,cex.axis = 1.5,ylim=c(0,20),xlab="Dose",main=target[ii],col=c("palegreen4","orange"))
